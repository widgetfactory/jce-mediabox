...
class plgSystemJCEMediabox extends JPlugin {
    ...
    function onAfterRender() {
        ...
        if (JFile::exists($file . DS . 'tooltip.html')) {
            ...
            $html .= '<!-- JCE MediaBox --><div id="jcemediabox-tooltip-html" class="jcemediabox-tooltip">' . $data . '</div><!-- JCE MediaBox -->';
        }
        ...
        if (JFile::exists($file . DS . 'popup.html')) {
            ...
            $html .= '<!-- JCE MediaBox --><div id="jcemediabox-popup-html"><div id="jcemediabox-popup-overlay"></div><div id="jcemediabox-popup-frame"><div id="jcemediabox-popup-body">' . $data . '</div></div></div><!-- JCE MediaBox -->';
        }
